...
sudo -i podman exec server bash -c "set -xe;npm --prefix web ci --ignore-scripts --save=false --omit=dev;npm --prefix web run build -- --check-spec=false; rsync -a dist/ /usr/share/susemanager/www/htdocs/"
