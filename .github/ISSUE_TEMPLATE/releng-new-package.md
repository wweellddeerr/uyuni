---
name: New package for SUSE Multi-Linux Manager/Uyuni
about: Use this template to request a new package to be added to SUSE Multi-Linux Manager/Uyuni
...
If the new package:
- Is going to be part of the SLE12/SLE15 client tools for a released SUSE Multi-Linux Manager version, or part of a SLE module, and
