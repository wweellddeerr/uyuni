---
name: Package version bump/rename for SUSE Multi-Linux Manager/Uyuni
about: Use this template to notify RE about a package version bump/rename for SUSE Multi-Linux Manager/Uyuni
title: 'Package version bump/rename for SUSE Multi-Linux Manager/Uyuni: XXXXXXX'
labels: ["vega-squad"]
projects: ["SUSE/35"]
assignees: ''
...
- [ ] Other (**please specify, only for exceptional situations**)
...
List here any related PRs for `SUSE/spacewalk`, `SUSE/uyuni-tools`, `uyuni-project/uyuni`, `uyuni-project/uyuni-tools`
